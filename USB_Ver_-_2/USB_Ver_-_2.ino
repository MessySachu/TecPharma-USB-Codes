...
//    Serial2.println("Initializing SD card...");
    ...
    delay(10);
//    Serial2.println("card initialized.");                                         // initialize the SD card 
...
//          Serial2.println("Started Printing");
          Serial.println("Started Printing");
          if(DataLogFile){
              while(DataLogFile.available()){
                //Serial2.println("Data Available");
                String PrepareData1;
                char TempCollector;
...
//    Serial2.println("Connection failed, Writing Data to Card");
